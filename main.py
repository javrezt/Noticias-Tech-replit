...
api_key = st.text_input("Agrega aquí tu API key", type="password")
    ...
    if st.button("Buscar"):
        if query and url:
            ...
            if response.status_code == 200:
                ...
                # Mostrar datos para depuración st.write("Datos enviados a la API:", data)  
                # Mostrar encabezados para depuración st.write("Encabezados:", headers)  
